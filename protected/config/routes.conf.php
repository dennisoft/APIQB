...
$route['get']['/entries'] = array('MainController', 'listing');
$route['get']['/entries/:trans_id'] = array('MainController', 'listing');
$route['get']['/entries/:trans_id/:paybill'] = array('MainController', 'listing');
$route['put']['/entries/:trans_id'] = array('MainController', 'update');
$route['post']['/entries'] = array('MainController', 'add');
$route['delete']['/entries/:trans_id'] = array('MainController', 'delete');
$route['post']['/api/auth/login'] = array('MainController', 'auth');
$route['post']['/api/auth/changepassword'] = array('MainController', 'changePassword');
